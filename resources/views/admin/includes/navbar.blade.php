    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="{{url('/brand-home')}}"><i class="fa fa-building  fa-fw"></i> MarketPlace View</a>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="{{ url('/admin-view-dealer') }}">Dealer</a>
                        </li>
                        <li>
                            <a href="{{ url('/admin-view-brand') }}">Brand</a>
                        </li>
                        <li>
                            <a href="{{ url('/admin-view-artist') }}">Artist</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
                ...
                <li>
                    <a href="#"><i class="fa fa-cogs fa-fw"></i> Service Info <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="{{ url('/manage-services') }}">Manage Services</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
