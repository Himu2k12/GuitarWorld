...
@section('content')
    ...
    <div class="main">
                ...
                <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                    <div class="pay-tabs">
                        ...
                        <ul class="resp-tabs-list">
                            ...
                            <li class="resp-tab-item" aria-controls="tab_item-3" role="tab"><span><label class="pic2" style="height: 70px;"></label>Debit Card</span></li>
                            <div class="clear"></div>
                        </ul>
                    </div>
                    <div class="resp-tabs-container">
                        <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                            <div class="payment-info">
                                ...
                                <form action="{{url('/service-money-payment')}}" method="post">
                                    {{csrf_field()}}
                                    <div class="tab-for">
                                        <h5>AMOUNT OF PAYMENT</h5>
                                        <input type="text" readonly name="payment_amount" style="color: #435964;" value="{{$services->total_cost}}" required/>
                                        <h5>NAME ON CARD</h5>
                                        <input type="text" name="name_on_card" style="color: #435964;" value="" required>
                                        <input type="hidden" name="user_id" style="color: #435964;" value="{{Auth::user()->id}}" required>
                                        <input type="hidden" name="service_id" style="color: #435964;" value="{{$services->id}}" required>
                                        <span style="color: red;">{{ $errors->has('name_on_card') ? $errors->first('name_on_card') : ' ' }}</span>
                                        <h5>CARD NUMBER</h5>
                                        <input class="pay-logo" style="color: #435964;" name="card_number" type="text" placeholder="0000-0000-0000-0000" required/>
                                    ...
                                    <div class="transaction">
                                        ...
                                        <div class="tab-form-right user-form-rt">
                                            <h5>CVV NUMBER</h5>
                                            <input type="text" style="color: #435964;" name="cvv_number" placeholder="xxxx" required="">
        ...
        <p class="footer">Copyright © 2018 Guitar World</p>
    </div>
